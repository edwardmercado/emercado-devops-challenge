...
# deploy cfn
aws cloudformation deploy --template ./packaged-template.json --stack-name emercado-tier-1-vpc-stack  --capabilities CAPABILITY_IAM --region us-east-1 --profile apper
